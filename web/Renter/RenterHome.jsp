    ...
    <body>
        ...
        <div class="hero">
            <div class="hero-slide">
                <div class="img overlay" style="background-image: url('new-image/hero_bg_3.jpg')"></div>
                <div class="img overlay" style="background-image: url('new-image/hero_bg_2.jpg')"></div>
                <div class="img overlay" style="background-image: url('new-image/hero_bg_1.jpg')"></div>
            </div>

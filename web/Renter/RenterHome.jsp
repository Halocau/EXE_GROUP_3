                ...
                <% List<Rooms> listRoomVip1 = (List<Rooms>) request.getAttribute("listRoomVip1"); %>
                        ...
                        <head>
                            ...
                            <style>
                                ...
                                /* Giá phòng nhấp nháy nổi bật Vip 1 */
                                .blink-price {
                                        ...
                                        <% for (int i=0; i < listRoomVip1.size(); i++) { %>
                                            <div class="col-md-3 col-lg-3 mb-4">
                                                <div
                                                    ...
                                                    <a
                                                        href="RenterRoomController?service=roomDetail&roomID=<%= listRoomVip1.get(i).getRoomID() %>">
                                                    ...
                                                    <div class="vip-col-5">
                                                        <div
                                                            ...
                                                            <span class="vip-badge vip-2"><span class="star">⭐</span>VIP
                                                                2</span>
                                                            <a
                                                                href="RenterRoomController?service=roomDetail&roomID=<%= listRoomVip2.get(i).getRoomID() %>">
                                                ...
                                                for (int i = 0; i < listRoomVip3.size(); i++) { %>
                                                    <div class="vip-col-5">
                                                        <div
                                                            ...
                                                            <a
                                                                href="RenterRoomController?service=roomDetail&roomID=<%= listRoomVip3.get(i).getRoomID() %>">

                                        ...
                                        <div class="col-lg-3" style="margin-left: -80px;">
                                            <div class="search-filter">
                                                ...
                                                <div class="price-range">
                                                    <label style="color: orange; font-size: 17px"
                                                        class="price-label">Price Levels</label><br>
                                                    <input type="checkbox" id="priceBelow1M" name="priceRange"
                                                        value="below1M" class="price-input" onclick="filterRooms(this)">
                                                    <label for="priceBelow1M" class="price-label">Under 1
                                                        million</label><br>
                                                    <input type="checkbox" id="price1To2M" name="priceRange"
                                                        value="1To2M" class="price-input" onclick="filterRooms(this)">
                                                    <label for="price1To2M" class="price-label">1-2 million</label><br>
                                                    <input type="checkbox" id="price2To3M" name="priceRange"
                                                        value="2To3M" class="price-input" onclick="filterRooms(this)">

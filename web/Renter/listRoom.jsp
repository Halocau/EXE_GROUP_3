        ...
        <% List<Rooms> listRoom = (List<Rooms>) request.getAttribute("rooms");
                List<Rooms> listAllRoom = (List<Rooms>) request.getAttribute("allRooms");
                        ...
                        <head>
                            ...
                            <link rel="stylesheet"
                                href="<%= request.getContextPath() %>/fonts/flaticon/font/flaticon.css">
                            ...
                            <style>
                                ...
                                .price-range label,
                                .building-filters label {
                                    margin-right: 10px;
                                }

                                .price-range input[type="checkbox"],
                                .building-filters input[type="checkbox"] {
                                    margin-right: 5px;
                                }
                        ...
                        <body>
                                        ...
                                        <div class="col-lg-3" style="margin-left: -80px;">
                                            <div class="search-filter">
                                                <div class="filter-card"
                                                    style="background: #fff; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); padding: 24px; margin-bottom: 24px;">
                                                    ...
                                                    <div style="margin-bottom: 18px;">
                                                        <label
                                                            style="font-weight: 500; margin-bottom: 8px; display: block;">Location</label>
                                                    ...
                                                    <div style="margin-bottom: 18px;">
                                                        <label
                                                            style="font-weight: 500; margin-bottom: 8px; display: block;">Price
                                                            Range</label>
                                                        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                                                            <label class="switch">
                                                                <input type="checkbox" id="priceAll" name="priceRange"
                                                                    value="all">
                                                                <span class="slider"></span> All
                                                            </label>
                                                            <label class="switch">
                                                                <input type="checkbox" id="priceBelow1M"
                                                                    name="priceRange" value="below1M">
                                                                <span class="slider"></span> &lt; 1M
                                                            </label>
                                                            <label class="switch">
                                                                <input type="checkbox" id="price1To2M" name="priceRange"
                                                                    value="1To2M">
                                                                <span class="slider"></span> 1-2M
                                                            </label>
                                                            <label class="switch">
                                                                <input type="checkbox" id="price2To3M" name="priceRange"
                                                                    value="2To3M">
                                                                <span class="slider"></span> 2-3M
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div style="margin-bottom: 18px;">
                                                        <label
                                                            style="font-weight: 600; margin-bottom: 10px; display: block; font-size: 16px;">Sort
                                                            by</label>
                                                        <div class="sort-radio-group">
                                                            <label class="sort-radio">
                                                                <input type="radio" name="sortSelect" value="none"
                                                                    checked>
                                                                <span class="custom-radio"></span>
                                                                <span class="sort-label">Default</span>
                                                            </label>
                                                            <label class="sort-radio">
                                                                <input type="radio" name="sortSelect" value="priceAsc">
                                                                <span class="custom-radio"></span>
                                                                <span class="sort-label">Price <svg width="16"
                                                                        height="16" style="vertical-align:middle">
                                                                        <polyline points="8,4 14,12 2,12"
                                                                            style="fill:none;stroke:#007bff;stroke-width:2" />
                                                                    </svg></span>
                                                            </label>
                                                            <label class="sort-radio">
                                                                <input type="radio" name="sortSelect" value="priceDesc">
                                                                <span class="custom-radio"></span>
                                                                <span class="sort-label">Price <svg width="16"
                                                                        height="16" style="vertical-align:middle">
                                                                        <polyline points="8,12 14,4 2,4"
                                                                            style="fill:none;stroke:#007bff;stroke-width:2" />
                                                                    </svg></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <style>
                                                    ...
                                                    .sort-radio input[type="radio"]:checked+.custom-radio {
                                                        border-color: #007bff;
                                                        background: #007bff;
                                                    }

                                                    .sort-radio input[type="radio"]:checked+.custom-radio:after {
                                                        content: '';
                                                        display: block;
                                                        width: 10px;
                                                        height: 10px;
                                                    ...
                                                    <% if (isRenter==0) { %>
                                                        ...
                                                        <div id="roomListContainer">
                                                            <div id="roomList" class="room-list-container row">
                                                                <% for (Rooms room : listRoom) { if
                                                                    (room.getRoomStatus()==1) { %>
                                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4"
                                                                        data-room-name="<%= room.getRoomNumber() %>"
                                                                        data-room-price="<%= room.getRoomFee().longValue() %>">
                                                                        <div class="property-item mb-30">
                                                                            <a href="OwnerController?service=roomDetail&roomID=<%= room.getRoomID() %>"
                                                                                class="img">
                                                                            ...
                                                                            <div class="property-content">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <a style="margin-right: 53px"
                                                                                        href="RenterRoomController?service=roomDetail&roomID=<%= room.getRoomID() %>"
                                                                                        class="btn btn-primary py-2 px-3">See
                                                                                        details</a>
                                                                                    <a style="background-color: #17a2b8;"
                                                                                        href="RenterRoomController?service=rentRoom&roomID=<%= room.getRoomID() %>"
                                                                                        class="btn btn-rent py-2 px-3">Rent</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div id="departmentAListContainer" style="display: none;">
                                                            <div id="allRoomList" class="room-list-container row">
                                                                <% for (Rooms room : listAllRoom) { if
                                                                    (room.getRoomStatus()==1 &&
                                                                    room.getRoomDepartment().trim().equals("A")) { %>
                                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4"
                                                                        data-room-name="<%= room.getRoomNumber() %>"
                                                                        data-room-price="<%= room.getRoomFee().longValue() %>"
                                                                        data-room-department="<%= room.getRoomDepartment() %>">
                                                                        <div class="property-item mb-30">
                                                                            <a href="OwnerController?service=roomDetail&roomID=<%= room.getRoomID() %>"
                                                                                class="img">
                                                                                <% String base64Image=room.getRoomImg();
                                                                            ...
                                                                            <div class="property-content">
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="d-block mb-2 text-black-50">Thon
                                                        ...
                                                        <div id="departmentBListContainer" style="display: none;">
                                                            <div id="departmentBList" class="room-list-container row">
                                                                <% for (Rooms room : listAllRoom) { if
                                                                    (room.getRoomStatus()==1 &&
                                                                    room.getRoomDepartment().trim().equals("B")) { %>
                                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4"
                                                                        data-room-name="<%= room.getRoomNumber() %>"
                                                                        data-room-price="<%= room.getRoomFee().longValue() %>">
                                                                        <div class="property-item mb-30">
                            ...
                            <div class="pagination" style="margin: 0px; padding-bottom: 50px">
                                <% for (int i=0; i < totalPage; i++) { %>
                                    <a href="RenterRoomController?service=listRoom&index=<%=i+1%>"
                                        class="<%= (i + 1 == index) ? " active" : "" %>"><%= i + 1 %></a>
                                    <% } %>
                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="widget">
                                                ...
                                                <ul class="list-unstyled links">
                                                    ...
                                                    <li><a href="tel://11234567890">+1(123)-456-789</a></li>
                                                    <li><a href="mailto:info@mydomain.com">fptuniversity@fpt.edu.vn</a>
                                                    </li>
                                                </ul>
                                            </div> <!-- /.widget -->
                                        </div> <!-- /.col-lg-4 -->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="widget">
                                                ...
                                                <ul class="list-unstyled social">
                                                    ...
                                                    <li><a href="https://www.facebook.com/elfadkeachother"><span
                            ...
                            <script src="<%= request.getContextPath() %>/lib/popper/popper.min.js"></script>
                            ...
                            <script src="<%= request.getContextPath() %>/lib/scrollreveal/scrollreveal.min.js"></script>


                            <!-- Template Main Javascript File -->
                            <script src="<%= request.getContextPath() %>/js/main_owner.js"></script>

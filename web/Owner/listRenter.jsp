<%-- Document : listRenter Created on : 4 thg 7, 2024, 23:21:05 Author : quocp --%>
                                                    ...
                                                    <div class="row mt-4">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="stat-box text-center p-3 bg-light rounded">
                                                                ...
                                                                <h3 class="mb-0">
                                                                    <%= stats.getTotalOccupants() %> people
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                ...
                                <div class="container mt-5">
                                    <ul class="nav nav-tabs justify-content-center" id="ownerTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link <%= (request.getParameter(" tab")==null || "rooms"
                                                .equals(request.getParameter("tab"))) ? "active" : "" %>" id="rooms-tab"
                                                data-bs-toggle="tab" data-bs-target="#rooms" type="button" role="tab"
                                                aria-controls="rooms" aria-selected="true">Room Detail
                                                Statistics</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link <%= " renters".equals(request.getParameter("tab"))
                                                ? "active" : "" %>" id="renters-tab" data-bs-toggle="tab"
                                                data-bs-target="#renters" type="button" role="tab"
                                                aria-controls="renters" aria-selected="false">List of Renters</button>
                                        </li>
                                    </ul>
                                    <div class="tab-content pt-3" id="ownerTabContent">
                                        <div class="tab-pane fade <%= (request.getParameter(" tab")==null || "rooms"
                                            .equals(request.getParameter("tab"))) ? "show active" : "" %>" id="rooms"
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <!-- Filter Form -->
                                                            <form method="get" action="ListRenterController"
                                                                class="row g-3 mb-3">
...
value="<%= request.getAttribute("searchRoomNumber") != null ? request.getAttribute("searchRoomNumber") : "" %>"
                                                                ...
                                                                <div class="col-md-2">
                                                                    <select name="status" class="form-select">
                                                                        <option value="all"
                                                                            ...
                                                                            || "all"
                                                                            .equals(request.getAttribute("status")))
                                                                        ...
                                                                        <option value="empty" <%="empty"
                                                                            .equals(request.getAttribute("status"))
                                                                            ? "selected" : "" %>>Empty</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <input type="number" name="minPrice"
                                                                        class="form-control" placeholder="Min Price"
                                                                        value="<%= request.getAttribute(" minPrice")
                                                                        !=null ? request.getAttribute("minPrice") : ""
                                                                        %>">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <input type="number" name="maxPrice"
                                                                        class="form-control" placeholder="Max Price"
                                                                        value="<%= request.getAttribute(" maxPrice")
                                                                        !=null ? request.getAttribute("maxPrice") : ""
                                                                        %>">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <button type="submit"
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        <% java.util.List<model.Rooms> filteredRooms =
                                                                            (java.util.List<model.Rooms>)
                                                                                request.getAttribute("filteredRooms");
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <% if(room.getRoomOccupant()> 0)
                                                                                            { %>
                                                                                            <span
                                                                                                class="badge bg-success">Occupied</span>
                                                                                            <% } else { %>
                                                                                                <span
                                                                                                    class="badge bg-secondary">Empty</span>
                                                                                                <% } %>
                                                                                    </td>
                                                                                    <td>
                                                            ...
                                                            <nav aria-label="Room pagination">
                                                                <ul class="pagination justify-content-center">
                                                                    <% Integer currentPage=(Integer)
                                                                        ...
                                                                        totalPages=(Integer)
                                                                        request.getAttribute("totalPages"); if
                                                                        (currentPage==null) currentPage=1; if
                                                                        (totalPages==null) totalPages=1; String
                                                                        searchRoomNumber=(String)
                                                                        request.getAttribute("searchRoomNumber"); String
                                                                        status=(String) request.getAttribute("status");
                                                                        String minPrice=(String)
                                                                        request.getAttribute("minPrice"); String
                                                                        maxPrice=(String)
                                        ...
                                        <div class="tab-pane fade <%= " renters".equals(request.getParameter("tab"))
                                            ? "show active" : "" %>" id="renters" role="tabpanel"
                                            ...
                                            <div class="row" id="roomContainer">
                                                <div class="table-container">
                                                    <table id="renterTable">
                                                        ...
                                                        <tbody>
                                                            <% for (model.RenterList renters :
                                                                (java.util.List<model.RenterList>)
                                                                request.getAttribute("listRenters")) { %>
                                                                <tr class="property-content">
                                                                    <td><a
                                                                            href="ViewRenterProfileController?renterID=<%= renters.getUserID() %>">
                                                                            <%= renters.getUserName() %>
                                                                        </a></td>
                                                                    <td>
                                                                        <%= renters.getRoomNumber() %>
                                                                    </td>
                                                                    <td>
                                                                        <%= renters.getRoomFloor() %>
                                                                    </td>
                                                                    <td>
                                                                        <%= renters.getBalance() %>
                                                                    </td>
                                                                    <td>
                                                                        <a
                                                                            href="roomfee?roomID=<%= renters.getRoomID() %>">See
                                                                            Detail</a>
                                                                    </td>
                                                                </tr>
                                                                <% } %>

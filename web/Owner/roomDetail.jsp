                        ...
                        <jsp:include page = "navbar.jsp"></jsp:include>
                            ...
                            <div class="section">
                               ...
                               String formattedFee = df.format(roomDetail.getRoomFee() * 1000); %>
                                            ...
                                            <% if (listNameRenter != null && !listNameRenter.isEmpty()) { %>
                                            <div class="contact-section">
                                                <h3 class="section-title">Current Renters</h3>
                                                <% for (String renterName : listNameRenter) { %>
                                                <p class="textDetail">Renter: <a style="color: blue;" href="#"> <%= renterName %> </a></p>
                                                <% } %>
                                            </div>
                                            <% } %>
                                            <div class="action-buttons" style="text-align: center; margin-top: 20px;">
                                                <a class="btn-rent" href="OwnerController?service=editRoom&roomID=<%= roomDetail.getRoomID()%>">
                                                    <i class="icon-pencil" style="margin-right: 8px;"></i>Edit Room
                                                </a>
                                            </div>
                                        </div>
                                    </div>

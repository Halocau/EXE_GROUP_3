...
<html lang="vi">
    <head>
        ...
        <style>
            /* chỉ reset cho 2 section của bạn */
            .membership-section *, .recharge-section * {
            ...
            .card-header.vip {
                background: linear-gradient(135deg, #d585ff, #6137ed);
            }
            .card-header.nova {
                background: linear-gradient(135deg, #6137ed, #6137ed);
            }
            .card-header h3 {
                font-size: 1.5rem;
                font-weight: 600;
            ...
            .card-header::after {
                ...
                width: 100%;
                height: 40px;
                background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="%23fff" d="M0,224L48,213.3C96,203,192,181,288,170.7C384,160,480,160,576,176C672,192,768,224,864,224C960,224,1056,192,1152,186.7C1248,181,1344,203,1392,213.3L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>') no-repeat bottom center;
            ...
            .membership-card.featured .btn-pay {
                background: #b157f7;
            }
            /* Recharge */
            .recharge-section {
            ...
            @media (max-width: 768px) {
                .membership-cards, .recharge-container {
                ...
                .btn-pay, .btn-primary, .btn-secondary {
            ...
            .modal-content {
                ...
                overflow-x: hidden;
                overflow-y: auto;
                z-index: 1001; /* nếu cần nổi trên navbar */
            }
            .modal-note {
                color: #777777;
                font-size: 0.875rem;      /* nhỏ hơn text chính */
                font-style: italic;       /* nghiêng cho nhẹ nhàng */
                margin-top: 0.5rem;       /* tạo khoảng cách */
                text-align: left;
            }
            .modal-field {
                text-align: left;
            ...
            .modal-qr img {
                display: block;
                max-width: 250px;    /* bạn có thể điều chỉnh con số này */
                width: 80%;          /* chiếm 80% chiều ngang modal */
                height: auto;        /* giữ tỉ lệ gốc */
                margin: 1rem auto;   /* căn giữa */
            }
            .card-header {
                position: relative;
                overflow: hidden;        /* quan trọng để wave ko vượt header */
                z-index: 1;              /* header nội dung trên sóng */
            }
            .card-header::after {
                content: '';
                position: absolute;
                ...
                background-size: cover;
                z-index: 0;               /* sóng nằm dưới */
            }
            .card-header h3,
            .card-header p {
                position: relative;      /* cho text nằm lên trên sóng */
                z-index: 2;
            }
        ...
        <style>
            /* Footer CSS */
            .footer {
                background: #054f45;      /* gần tương tự navbar */
                color: #f5f5f5;
                font-family: 'Poppins', sans-serif;
                padding-top: 2rem;
            }
    ...
    <body>
        ...
        <section class="membership-section">
            ...
            <p class="desc">
                ...
                các bạn cần phải đăng ký tin VIP dưới đây là các gói thành viên cùng với các đặc quyền theo từng gói.
            </p>
        ...
        <div id="payment-modal" class="modal">
            <div class="modal-content">                
                <span class="modal-close" style="position:absolute; top:0.5rem; right:1rem; font-size:1.5rem; cursor:pointer;">&times;</span>
                ...
                <div class="modal-field">
                    ...
                    <div class="copy-group">
                        ...
                        <button type="button" id="modal-copy-btn" title="Sao chép"><i class="fa-regular fa-copy"></i></button>
                    </div>
                    <!-- Dòng thông báo mờ -->
                    <p class="modal-note">

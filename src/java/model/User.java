...
public class User {
    ...
    public User(int userID, String userName, String userGender, String userBirth, String userAddress, String userPhone, String userAvatar, Account account, int vipId, Renter renter, Room room, Security security, String email, BigDecimal wallet) {
        this.userID = userID;
